...
const HeroSection = ({ openTopUpModal, scrollToFeaturedGames, heroImages = [] }) => {
  const [currentSlide, setCurrentSlide] = useState(0)
  const [slideDirection, setSlideDirection] = useState(null)

  // Use provided hero images or fallback to defaults
  const backgroundImages =
    heroImages.length > 0
      ? heroImages.map((img) => img.url)
      : ["/images/hero-bg.jpg", "/images/hero2-bg.jpg", "/images/hero3-bg.jpg", "/images/hero4-bg.jpg"]
